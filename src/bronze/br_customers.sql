-- =============================================================
-- br_customers.sql  —  Bronze ingestion: Customers
--
...
CREATE OR REFRESH STREAMING TABLE `01_bronze`.br_customers
COMMENT 'Customers — raw, ingested from landing via Auto Loader'
AS SELECT
  *,
