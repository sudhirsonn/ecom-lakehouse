-- =============================================================
-- br_sellers.sql  —  Bronze ingestion: Sellers
--
...
CREATE OR REFRESH STREAMING TABLE `01_bronze`.br_sellers
COMMENT 'Sellers — raw, ingested from landing via Auto Loader'
AS SELECT
  *,
