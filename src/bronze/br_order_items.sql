-- =============================================================
-- br_order_items.sql  —  Bronze ingestion: Order line items
--
...
CREATE OR REFRESH STREAMING TABLE `01_bronze`.br_order_items
COMMENT 'Order line items — raw, ingested from landing via Auto Loader'
AS SELECT
  *,
...
FROM STREAM read_files(
  '${landing_volume_path}/order_items/',
  format              => 'csv',
  header              => 'true',
