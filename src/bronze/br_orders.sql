-- =============================================================
-- br_orders.sql  —  Bronze ingestion: Orders
--
...
CREATE OR REFRESH STREAMING TABLE `01_bronze`.br_orders
COMMENT 'Orders — raw, ingested from landing via Auto Loader'
AS SELECT
  *,
