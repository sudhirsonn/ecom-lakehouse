-- =============================================================
-- br_products.sql  —  Bronze ingestion: Products
--
...
CREATE OR REFRESH STREAMING TABLE `01_bronze`.br_products
COMMENT 'Products — raw, ingested from landing via Auto Loader'
AS SELECT
  *,
