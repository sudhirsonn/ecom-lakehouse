-- =============================================================
-- br_reviews.sql  —  Bronze ingestion: Reviews (nested meta)
--
...
CREATE OR REFRESH STREAMING TABLE `01_bronze`.br_reviews
COMMENT 'Reviews (nested meta) — raw, ingested from landing via Auto Loader'
AS SELECT
  *,
